...
// SEGURIDAD: Solo el administrador puede ejecutar este script
if (!isset($_SESSION['user_rol']) || $_SESSION['user_rol'] !== 'admin') {
    header('HTTP/1.1 403 Forbidden');
    die("<body style='background:#0f172a;color:#ff4d4d;display:flex;justify-content:center;align-items:center;height:100vh;margin:0;font-family:sans-serif;'><h1 style='font-size:4rem;text-align:center;'>403 Acceso Denegado</h1></body>");
}
